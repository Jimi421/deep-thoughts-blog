...
date: "2025-10-29"
status: "published"
summary: "Test our theory to see if what we think the problem is, try to fix it. if the thory does not work make a new theory. figure out what the next theory is."
tags: ["network+"]
toc: true
---
