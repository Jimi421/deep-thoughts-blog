...
date: "2025-10-29"
status: "published"
summary: "Pulblic - routable uniqeu ip address assigned to each device on the internet that allows it to communciate with other addresses on the network . dotted decimal notatpoon eg 66.51.4"
tags: ["network+"]
toc: true
---
