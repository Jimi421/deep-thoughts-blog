...
date: "2025-10-29"
status: "published"
summary: "802.1Q Tagging -  VLAN tagging refers to the standard that allows the frame to have a ethernet tag inserted into it to help the switch to ID. creates the logical separation on the "
tags: ["network+"]
toc: true
---
