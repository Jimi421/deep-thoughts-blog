...
status: published
summary: >-
  Converts a hostname to an ip address and an ip address to a hostname. DNS is
  an embedded part of networks and systems. You can set up your own DNS server
  to have your own domain na
tags:
  - network+
toc: true
