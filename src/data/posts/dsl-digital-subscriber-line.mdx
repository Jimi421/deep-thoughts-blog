...
status: published
summary: >-
  ADSL - Asymmetric DSL has different downloand and upload
  [speeds](HTTP://speeds.post) most people download more than they upload so
  this tends to work for most users. Speeds are st
tags:
  - network+
toc: true
