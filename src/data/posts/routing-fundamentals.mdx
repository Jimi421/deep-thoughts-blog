...
status: published
summary: >-
  Router forwards traffic between subnets, between interneal network and
  externetal neteork, or two extenal networks.. each subnet or external netwrok
  is going to be it’s own broadca
tags:
  - network+
toc: true
