...
date: "2025-10-29"
status: "published"
summary: "Method for increasing the security of a given netowkr by inspecing the devices tryin tto connect a network. checks to see if a device is secure enough for the netowk. like going th"
tags: ["network+"]
toc: true
---
