...
status: published
summary: >-
  Detection Method - Security contol used in an event to find out if something
  malicious may have happened - camera ect.. inside or outside rooms with
  netwokring gear. parking lot, e
tags:
  - network+
toc: true
