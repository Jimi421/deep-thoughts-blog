...
date: "2025-10-29"
status: "published"
summary: "static assignemnt: manually typing in the IP address. can be time consuming and prone to error. static assignemts is impractical on large enterprise neteorks."
tags: ["network+"]
toc: true
---
