...
date: "2025-10-29"
status: "published"
summary: "Recognizes network attacks and and ips can respond accordingly. will look at signature and behaviour based. SNORT is an IDS/IPS it’s a passive device.  if it see’s something it wil"
tags: ["network+"]
toc: true
---
...
👉 Do you want me to also make a **comparison table (IDS vs IPS, Signature vs Policy vs Anomaly)** so you have it all in one glance for quick recall?