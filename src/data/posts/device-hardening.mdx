...
status: published
summary: >-
  Ensures a device has ahd any unnecessary applicaitons services or ports
  disables or removed from the host. Makes a configurations that reduces attack
  surface . only nessessary serv
tags:
  - network+
toc: true
