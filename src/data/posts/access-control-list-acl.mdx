...
status: published
summary: >-
  List of permission sassociated with a given system or network resource. Can be
  applied to any packet filttering device. ip address port or applicatons. it
  starts at the top and wor
tags:
  - network+
toc: true
