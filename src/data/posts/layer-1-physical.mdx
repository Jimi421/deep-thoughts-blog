...
status: published
summary: >-
  Where transmission of bits across the network occurs. Includes the physical
  and electrical network characteristics. It is bits, 1 and 0. Yes and no on and
  off. If it’s a copper wir
tags:
  - network+
toc: true
