...
status: published
summary: >-
  pre-shared key (psk) - Security authentication where the same password or key
  is bieng use on both th ewireless access point and any connecting clintdevices
  trying to gain acess to
tags:
  - network+
toc: true
